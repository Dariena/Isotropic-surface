    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a class="brand" href="${pageContext.request.contextPath}/app/home">SurfaceBuilder</a>
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        <li><a href="${pageContext.request.contextPath}/app/example">Example</a></li>
                        <li><a href="${pageContext.request.contextPath}/app/modeling">Modeling Surface</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Language<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a type="submit" href="${pageContext.request.contextPath}/?lang=uk_ua">UA</a></li>
                                <li class="divider"></li>
                                <li><a type="submit" href="${pageContext.request.contextPath}/?lang=en_uk">EN</a></li>
